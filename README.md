...
* [work](#module_work)
  * [.Queue](#module_work.Queue)
    ...
    * [.queued](#module_work.Queue#queued) : <code>Array</code>
    ...
    * [.view()](#module_work.Queue#view) ⇒ <code>QueueView</code>
  ...
  * [.Task](#module_work.Task) ⇐ <code>module:state-machine</code>
    ...
    * _instance_
      * [.promise](#module_work.Task#promise) : <code>external:Promise</code>
      * [.resolver](#module_work.Task#resolver) : <code>function</code> &#124; <code>Array.&lt;function()&gt;</code>
      * [.name](#module_work.Task#name) : <code>string</code>
      * [.data](#module_work.Task#data) : <code>string</code>
      * [.process()](#module_work.Task#process)
      * [.cancel()](#module_work.Task#cancel)
      * [.view()](#module_work.Task#view) ⇒ <code>module:dom-view</code>
...
<a name="module_work.Queue#queued"></a>
...
#### queue.view() ⇒ <code>QueueView</code>
...
| Param | Type | Description |
| --- | --- | --- |
|  | <code>Element</code> | the parent element under which to place the view |
...
<a name="module_work.Task#promise"></a>
...
<a name="module_work.Task#resolver"></a>
...
**Kind**: instance property of <code>[Task](#module_work.Task)</code>  
<a name="module_work.Task#name"></a>
#### task.name : <code>string</code>
useful for debug output

**Kind**: instance property of <code>[Task](#module_work.Task)</code>  
<a name="module_work.Task#data"></a>
...
**Kind**: instance method of <code>[Task](#module_work.Task)</code>  
<a name="module_work.Task#view"></a>
#### task.view() ⇒ <code>module:dom-view</code>
Returns a view for a Task

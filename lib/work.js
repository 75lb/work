...
function Job(options){
    ...
    */
    this.on(E_MONITOR, function(job, eventName, data){
        if (self.parent) self.parent.emit(E_MONITOR, job, eventName, data);
...
function runParallel(){
    ...
    if (firstChild){
        // this.on(E_COMPLETE, firstChild.run);
        // this.on(E_IGNORED, firstChild.run);
        this.on(E_COMPLETE, function(){
            l("running firstchild: " + firstChild.name)
            firstChild.run();
        });
        this.on(E_IGNORED, function(){
            l("running firstchild: " + firstChild.name)
